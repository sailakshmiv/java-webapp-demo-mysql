...
public class See_BankaccountsServlet extends HttpServlet {
		...
		public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
			...
			returnSet = "<!DOCTYPE html> <html> <head> <meta charset=\"utf-8\"> <title> Java Demo. </title> <link rel=\"stylesheet\" type=\"text/css\" href=\"/css/index.css\"> </head> <body> <div class = \"box_logo\"> <img src= \"/JavaWebappDemo-mySQL-0.0.1-SNAPSHOT/images/logo.png\" class =\"logo\"/> </div> <div class =\"box_main_part\"><h1> Available bank accounts on this server: </h1>";
